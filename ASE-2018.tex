...
In this section, we present the known limitations of the hybrid model persistence. The hybrid model persistence is built upon the Eclipse Modeling Framework. Thus, the change-based component can support persisting information about the subsets of Ecore, such as classes, single and multi-valued features (attributes and references), datatypes, and containment. The change-based component supports persisting changes of models in the form of atomic events, such as creating and deleting an object, setting and unsetting a feature, moving a value or object within a multi-valued feature, removing and adding a value or object from and to a feature, and session (a course from starting editing a model, or after performing previous saving, to saving the model). 
