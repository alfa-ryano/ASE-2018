...
We repeated our experiments 22 times for each dimension measured. Since the data was not normally distributed and we wanted to calculate the significance of differences of mean ranks, we used the Mann-Whitney-Wilcoxon nonparametric test \cite{doi:10.1002/9780470479216.corpsy0524}.

since the data gathered are  .
